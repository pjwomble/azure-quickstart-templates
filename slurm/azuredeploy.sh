...
do
   ...
   echo "look here" >> /tmp/azuredeploy.log.$$
   echo $WORKER_NAME$i >> /tmp/azuredeploy.log.$$
   ...
   echo "look here2" >> /tmp/azuredeploy.log.$$
   echo $WORKER_IP_BASE$workerip $WORKER_NAME$i >> /tmp/azuredeploy.log.$$
